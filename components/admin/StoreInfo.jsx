...
import {MapPin, Mail, Phone, UserCircle2} from "lucide-react"
    ...
    return (
        <div className="flex-1 space-y-2 text-sm">
            ...
            {store.logo ? (
                ...
                <div className="w-24 h-24 flex items-center justify-center bg-gray-100 rounded-full max-sm:mx-auto">
                    <UserCircle2 size={36} className="text-gray-400"/>
                </div>
            )}

            {/* Store Name, Username, Status */}
          ...
          {store.status}
            ...
            <p className="text-slate-700 mt-5">
                Applied on <span className="text-xs">{new Date(store.createdAt).toLocaleDateString()}</span> by
            </p>
