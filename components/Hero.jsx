            ...
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div
                            ...
                            <span
                                className='bg-green-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEWS</span> Free
                            Shipping on Orders Above ৳1000 <ChevronRightIcon className='group-hover:ml-2 transition-all'
                                                                            size={16}/>
                        </div>
                        ...
                        <div className="mt-6 md:mt-14">
                            <Link href="/shop"
                                  className='bg-slate-800 text-white text-sm py-2.5 px-7 sm:py-5 sm:px-12 sm:mt-10 rounded-md hover:bg-slate-900 hover:scale-103 active:scale-95 transition'>
                                SHOP NOW
                            </Link>
                        </div>
                    </div>
                    <Image className='sm:absolute bottom-0 right-0 md:right-0 w-sm'
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div
                        ...
                        <div>
                            <p className='text-3xl font-medium bg-gradient-to-r from-slate-800 to-[#FFAD51] bg-clip-text text-transparent max-w-40'>Best
                                products</p>
                            <Link href="/shop" className='flex items-center gap-1 mt-4'>View more <ArrowRightIcon
                                className='group-hover:ml-2 transition-all' size={18}/></Link>
                        </div>
